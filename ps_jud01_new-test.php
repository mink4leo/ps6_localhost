                ...
                <tr>
                    ...
                    <td>
                        ...
                        <div class="flex-container">
                            ...
                            ?>
                                <input type="button" value="<?php echo number_format($i, 1); ?>" onClick="document.location.href='?j=<?= $_GET['j'] ?>&pre1=<?php echo number_format($i, 1); ?>#ACCPRE'" <?php if ($_SESSION['pre1'] == number_format($i, 1)) { ?> class="blue-text" <?php }   ?>>
                            <?php } ?>
                        </div>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <div class="flex-container">
                            ...
                            for ($i = 2.0; $i > 0.4; $i = $i - 0.1) {
                            ?>
                                <input type="button" value="<?php echo number_format($i, 1); ?>" onClick="document.location.href='?j=<?= $_GET['j'] ?>&pre2=<?php echo number_format($i, 1); ?>#ACCPRE'" <?php if ($_SESSION['pre2'] == number_format($i, 1)) { ?> class="blue-text" <?php }   ?>>
                            <?php } ?>
                        </div>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <div class="flex-container">
                            ...
                            for ($i = 2.0; $i > 0.4; $i = $i - 0.1) {
                            ?>
                                <input type="button" value="<?php echo number_format($i, 1); ?>" onClick="document.location.href='?j=<?= $_GET['j'] ?>&pre3=<?php echo number_format($i, 1); ?>#ACCPRE'" <?php if ($_SESSION['pre3'] == number_format($i, 1)) { ?> class="blue-text" <?php }   ?>>
                            <?php } ?>
                        </div>
